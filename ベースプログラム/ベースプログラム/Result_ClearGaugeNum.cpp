...
// コンストラクタ
//*************************************************************************
Result_ClearGaugeNum::Result_ClearGaugeNum(int nData)
{
	// ゲージの％数をリセット
	//**********************************************************************
	nGauge = nData;
	...
	for( int i = 0 ; i < nObject_Num ; i ++ )
	{
		// 座標(画像の中心を原点)
		//******************************************************************
		Tex_2D_Data[i].Obj_Pos	= D3DXVECTOR3(	1046.0f + 15.0f * i, 345.0f, 0.0f );

		// オブジェクトのサイズ(X,Y)
		//******************************************************************
		Tex_2D_Data[i].Obj_Size	= D3DXVECTOR2( 15.0f, 30.0f );
...
// デストラクタ
//*************************************************************************
Result_ClearGaugeNum::~Result_ClearGaugeNum(void)
{
...
// 更新処理
//*************************************************************************
void Result_ClearGaugeNum::Update(void)
{
	if ( nGauge != nGauge_Work )
	{
		nFrame_Cnt++;
	...
	for (int i = 0; i < nObject_Num; i++)
	{
		...
		{
		case 0:	// 百の位
			nNum = nGauge_Work / 100;
			break;

		case 1:	// 十の位
			nNum = nGauge_Work % 100 / 10;
			break;

		case 2:	// 一の位
			nNum = nGauge_Work % 100 % 10 / 1;
			break;
...
// 描画処理
//*************************************************************************
void Result_ClearGaugeNum::Draw(void)
{
	for (int i = 0; i < nObject_Num; i++)
	{
