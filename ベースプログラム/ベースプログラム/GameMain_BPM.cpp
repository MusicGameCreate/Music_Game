...
// コンストラクタ
//*************************************************************************
GameMain_BPM::GameMain_BPM(int bpm)
{
	// オブジェクトを何個作成するか？(最低 1～)
	//**********************************************************************
	nObject_Num = 3;
	...
	for (int i = 0; i < nObject_Num; i++)
	{
		// 座標(画像の中心を原点)
		//******************************************************************
		Tex_2D_Data[i].Obj_Pos = D3DXVECTOR3(280.0f + 48.0f * i, 92.0f, 0.0f);
...
// デストラクタ
//*************************************************************************
GameMain_BPM::~GameMain_BPM(void)
{
...
void GameMain_BPM::Update(void)
{
	...
	for (int i = 0; i < nObject_Num; i++)
	{
		...
		case 1:	// 十の位
			nNum = nNow_BPM % 100 / 10;
			break;

		case 2:	// 一の位
			nNum = nNow_BPM % 100 % 10 / 1;
			break;
		}
